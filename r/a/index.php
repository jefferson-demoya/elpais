...
<body id="page-top">
	<div id="wrapper">
		...
		<li class="nav-item">
			...
			<li class="nav-item">
				<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseVer" aria-expanded="false" >
					<i class="fas fa-info-circle"></i>
					<span>Ver otras listas</span>
				</a>
			</li>	
			<hr class="sidebar-divider">
			...
			<div id="content">
				...
				<div class="container">
					<div id="accordion">
						...
						<div id="collapseVer" class="collapse " aria-labelledby="heading" data-parent="#accordion">
							<div class="card-body">
								<?php include 'otras-listas.php' ?>
							</div>
						</div>
					</div>
				</div>
